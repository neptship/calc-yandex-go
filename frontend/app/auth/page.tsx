...
export default function AuthPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      console.log("Sending login request with:", { login: username });
      ...
      if (data.token) {
        ...
        if (data.user && (data.user.login !== undefined || data.user.username !== undefined)) {
          userLogin = data.user.login || data.user.username;
        ...
        console.log("Using extracted user data:", { userId, userLogin });
